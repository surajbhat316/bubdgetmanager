...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="row offset-sm-4 m-xs-1">
      <div class="col-12 col-sm-6 shadow-lg p-0 mt-5 bg-white rounded ">
        <div class="card">
            <h3 class="card-header bg-primary text-white">About us</h3>

          <div class="row p-2 ">
            <div class="col-12 col-sm-12">
              We are a group of techno crats who came up with an idea of solving budget
              and time issues that we usually face in our daily routines. We are here to provide you a budget controller
              to your aspects. <br><br>
